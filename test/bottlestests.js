...
describe('99 Bottles', function () {
  ...
  it.skip('can produce another verse', function () {
    var expected = [
  ...
  it.skip('can produce verse two', function () {
    var expected = [
  ...
  it.skip('can produce verse one', function () {
    var expected = [
  ...
  it.skip('can produce verse zero', function () {
    var expected = [
  ...
  it.skip('can produce two verses', function () {
    var expected = [
      '99 bottles of beer on the wall, 99 bottles of beer.',
      'Take one down and pass it around, 98 bottles of beer on the wall.',
      '',
  ...
  it.skip('can produce a few verses', function () {
    var expected = [
      '2 bottles of beer on the wall, 2 bottles of beer.',
      'Take one down and pass it around, 1 bottle of beer on the wall.',
      '',
  ...
  it.skip('can produce the song', function () {
    var expected = [
      '99 bottles of beer on the wall, 99 bottles of beer.',
      'Take one down and pass it around, 98 bottles of beer on the wall.',
      '',
    ...
    var bottles = new Bottles;
    expect(bottles.song()).to.equal(expected);
  });

  it.skip('can produce six pack in place of 6 bottles', function () {
    var expected = [
      '7 bottles of beer on the wall, 7 bottles of beer.',
      'Take one down and pass it around, 1 sixpack of beer on the wall.',
    ].join('\n');
    ...
    var bottles = new Bottles;
    expect(bottles.verse(7)).to.equal(expected);
  });

  it.skip('can produce six pack on the wall', function () {
    var expected = [
      '1 sixpack of beer on the wall, 1 sixpack of beer.',
      'Take one down and pass it around, 5 bottles of beer on the wall.',
    ].join('\n');
    ...
    var bottles = new Bottles;
    expect(bottles.verse(6)).to.equal(expected);
  });
});
